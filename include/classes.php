...
class mf_fortnox
{
	...
	function fetch_from_api($data)
	{
		...
		if($setting_fortnox_client_id != '' && $setting_fortnox_client_secret != '')
		{
			switch($data['endpoint'])
			{
				...
				case 'vouchers':
					//$url = "https://api.fortnox.se/3/vouchers/";
					...
					//$url = "https://api.fortnox.se/3/vouchers/?voucherseries=S";

					//$url = "https://api.fortnox.se/3/vouchers/A/1?financialyear=1";
					/*array ( 'Voucher' => array ( '@url' => 'https://api.fortnox.se/3/vouchers/A/1?financialyear=1', 'Comments' => NULL, 'CostCenter' => '', 'Description' => 'Inbetalning medlemsavgift Swish / Per Knutsson', 'Project' => '', 'ReferenceNumber' => '', 'ReferenceType' => '', 'TransactionDate' => '2025-10-15', 'VoucherNumber' => 1, 'VoucherRows' => array ( 0 => array ( 'Account' => 1901, 'CostCenter' => '', 'Credit' => 0, 'Description' => 'Swish Nordea', 'Debit' => 500, 'Project' => '', 'Removed' => false, 'TransactionInformation' => 'Per Knutsson RT13 1802779574441645 / Swishnummer: 1232335578', 'Quantity' => 0, ), 1 => array ( 'Account' => 3000, 'CostCenter' => '', 'Credit' => 500, 'Description' => 'Försäljning inom Sverige', 'Debit' => 0, 'Project' => '', 'Removed' => false, 'TransactionInformation' => 'Per Knutsson RT13 1802779574441645 / Swishnummer: 1232335578', 'Quantity' => 0, ), ), 'VoucherSeries' => 'A', 'Year' => 1, 'ApprovalState' => 0, ), )*/
					...
					switch($headers['http_code'])
					{
						...
						case 201:
							...
							{
								case 'insert':
									do_log("Vouchers: ".var_export($arr_json, true));
								break;
	...
	function cron_base()
	{
		...
		if($obj_cron->is_running == false)
		{
			...
			//$this->fetch_from_api(['endpoint' => 'orders', 'action' => 'insert']);
