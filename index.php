...
Documentation: https://support.fortnox.se/kom-igang/integrationer/kom-igang-med-utvecklarportalen https://www.fortnox.se/developer/authorization https://api.fortnox.se/apidocs
*/
...
if(!function_exists('is_plugin_active') || function_exists('is_plugin_active') && is_plugin_active("mf_base/index.php"))
{
	...
	if(is_admin())
	{
		...
		add_filter('posts_orderby', array($obj_fortnox, 'posts_orderby'), 10, 2);

		add_action('restrict_manage_posts', array($obj_fortnox, 'restrict_manage_posts'));
		add_action('pre_get_posts', array($obj_fortnox, 'pre_get_posts'));
	...
	add_filter('get_payment_status', array($obj_fortnox, 'get_payment_status'), 10, 2);
	...
	function uninstall_fortnox()
	{
		...
		mf_uninstall_plugin(array(
			'options' => array('setting_fortnox_client_id', 'setting_fortnox_client_secret', 'setting_fortnox_scope', 'option_fortnox_scope', 'option_fortnox_database_number', 'setting_fortnox_authorization_code', 'setting_fortnox_access_token', 'setting_fortnox_refresh_token', 'setting_fortnox_endpoint', 'setting_fortnox_endpoint_page', 'setting_fortnox_vouchers_series', 'setting_fortnox_debug', 'option_fetch_from_api_invoices_page', 'option_fetch_from_api_payments_page', 'option_fetch_from_api_vouchers_page', 'option_fetch_from_api_lastmodified'),
